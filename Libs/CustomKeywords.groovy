...
def static "com.mw.mobile.ifStatement.getCurrentSessionMobileDriver"() {
    (new com.mw.mobile.ifStatement()).getCurrentSessionMobileDriver()
}
...
def static "com.mw.mobile.errorHandling.handleErrorMessageVersion2"() {
    (new com.mw.mobile.errorHandling()).handleErrorMessageVersion2()
}
