...
class PressActionOneAndTwoSteps {

	@Given("user is in the cards tab")
	def user_is_in_the_cards_tab() {
		Mobile.tap(findTestObject('AppWerkGroep/Cards tab/Cards tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)
	}

	@When("action buttons 1 and 2 are visible")
	def action_buttons_1_and_2_are_visible() {
	...
	@Then("user can tap on them")
	def user_can_tap_on_them() {
